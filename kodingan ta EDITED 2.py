...
def tombol_klik():
    ...
    for iter in range(0,2):
        for x in os.listdir(directory_path):
            ...
            #Running ke 3 = Dilakukan Denoising    
            # Savitzky-Golay filter
            y1_filtered = savgol_filter(Dat,1001,3)
            fs = 1000
            cutoff_high = 0.5
            cutoff_low = 2
            powerline = 60
            ...
            #Running ke 4 = Perhitungan SNR, PSNR dan MSE
            # Mse
            ...
            # FEATURE EXTRACTION BUKAN DENOISING (Dari Sini)
            try:
                # Arithmetic Maximum
                MAKS=Max(y_filtered)
                # Arithmetic Mean
    ...
    #Running 5 = Print Hasil SNR, PSNR dan MSE
